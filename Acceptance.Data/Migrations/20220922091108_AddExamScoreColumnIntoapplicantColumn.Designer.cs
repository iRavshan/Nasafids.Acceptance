...
namespace Acceptance.Data.Migrations
{
    ...
    [Migration("20220922091108_AddExamScoreColumnIntoapplicantColumn")]
    partial class AddExamScoreColumnIntoapplicantColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acceptance.Domain.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acceptance.Domain.Payment", b =>
                {
                    b.HasOne("Acceptance.Domain.Applicant", "Applicant")
                        .WithMany("Payments")
                        .HasForeignKey("ApplicantId");

                    b.HasOne("Acceptance.Domain.Mover", "Mover")
                        .WithMany("Payments")
